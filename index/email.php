...
<body>
	...
	<h2>Adding a phone number is optional, but always a good idea,
		<br>
	 because it ensures an extra level of privacy.</h2>
	<img class="gmail" src="complete_email.jpg">
	<h2>Most applications will require that you agree to terms of use. 
		<br>
	Terms of use are an agreement between you (the user) and the company 
		<br>
	that created the app you are using.
	</h2>
	<img class="gmail" src="terms.jpg">
	<h2>Ready to get started? Great! Simply click on this <a href="https://accounts.google.com/SignUp">link</a>,
		<br>
	 and you'll be taken to google to create your own email address.</h2>
</body>
</html>